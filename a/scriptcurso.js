...
function showUniversityInfo(university) {
  ...
  if (university === 'A') {
    infoText.textContent = "Edificio A ofrece una amplia variedad de cursos en distintas áreas de la tecnología y las ciencias sociales.";
  } else if (university === 'B') {
    infoText.textContent = "Edificio B es conocida por su enfoque en las artes y las ciencias humanas, con un campus vibrante y multicultural.";
  } else if (university === 'C') {
    infoText.textContent = "Edificio C tiene una fuerte orientación hacia la investigación científica y la ingeniería, con modernas instalaciones.";
  }
